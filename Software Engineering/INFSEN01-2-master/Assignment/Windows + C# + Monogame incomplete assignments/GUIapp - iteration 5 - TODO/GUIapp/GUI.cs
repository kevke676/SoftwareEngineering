...
namespace GUIapp
{
    ...
    public abstract class GuiElement : Drawable, Updateable
    {
        ...
        public GuiElement(Point top_left_corner, Action action)
        {
    ...
    public class Label : GuiDecorator
    {
    ...
    {
        public GuiDecorator(Point top_left_corner, Action action) : base(top_left_corner, action)
        {
            if (action == null)
            {
